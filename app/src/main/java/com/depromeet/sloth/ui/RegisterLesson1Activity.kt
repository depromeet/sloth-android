...
class RegisterLesson1Activity : BaseActivity<RegisterViewModel, ActivityRegisterLesson1Binding>() {
    ...
    override fun initViews() = with(binding) {
        ...
        itemList.add(RegisterEntity("강의 이름", "강의 이름을 입력해주세요"))
        ...
        registerButton.setOnClickListener {
            ...
            if (flag == 0) {
                ...
                itemList.add(0, RegisterEntity("강의 제목", "강의 제목을 입력해주세요"))
            ...
            if (flag == 1) {
                itemList.add(0,RegisterEntity("강의 개수", "강의 개수를 입력해주세요"))
                Log.d("itemListSize", itemList[0].toString())
            ...
            if (flag == 2) {
                itemList.add(0,RegisterEntity("강의 사이트", "강의 사이트를 입력해주세요"))
                Log.d("itemListSize", itemList[0].toString())
