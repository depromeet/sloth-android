...
class RegisterLesson2Activity : BaseActivity<RegisterViewModel, ActivityRegisterLesson2Binding>() {
    ...
    private val itemList : ArrayList<RegisterEntity> = ArrayList()
    ...
    override fun initViews() = with(binding) {
        ...
        itemList.add(RegisterEntity("강의 시작일", "강의 이름을 입력해주세요"))
        ...
        registerButton.setOnClickListener {
            ...
            if (flag == 0) {
                ...
                itemList.add(0, RegisterEntity("완강 목표일", "강의 제목을 입력해주세요"))
            ...
            if (flag == 1) {
                itemList.add(0, RegisterEntity("강의 금액", "예)10,000원"))
                Log.d("itemListSize", itemList[0].toString())
            ...
            if (flag == 2) {
                itemList.add(0, RegisterEntity("푸시 알람주기", "강의 사이트를 입력해주세요"))
                Log.d("itemListSize", itemList[0].toString())
            ...
            if (flag == 3) {
                itemList.add(0, RegisterEntity("각오 한 마디(선택)", "최대 30자 까지 입력 가능합니다."))
                Log.d("itemListSize", itemList[0].toString())
    ...
    private fun fillProgressbar(count: Int, default: Int) {
        val animation = ObjectAnimator.ofInt(binding.progressbar, "progress", default + ceil((count-1)*12.5).toInt(), default + ceil(count*12.5).toInt())
