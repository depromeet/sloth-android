package com.depromeet.sloth.presentation.ui
...
import com.depromeet.sloth.presentation.ui.base.BaseActivity
...
class MainActivity : BaseActivity<ActivityMainBinding>(R.layout.activity_main) {
    ...
    private fun initNavigation() = with(binding) {
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            when (destination.id) {
                R.id.today_lesson, R.id.lesson_list, R.id.manage, R.id.finish_lesson_dialog, R.id.logout_dialog, R.id.update_member_dialog, R.id.on_boarding_check_detail_dialog ->
